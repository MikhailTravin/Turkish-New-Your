...
document.addEventListener('DOMContentLoaded', () => {
	const newYear = new Date('Jan 4 2022 00:00:00');
...
document.addEventListener('DOMContentLoaded', () => {
	...
	const daysVal = document.querySelector('.time-count-two__days .time-count-two__val');
	const hoursVal = document.querySelector('.time-count-two__hours .time-count-two__val');
	const minutesVal = document.querySelector('.time-count-two__minutes .time-count-two__val');
	const secondsVal = document.querySelector('.time-count-two__seconds .time-count-two__val');
